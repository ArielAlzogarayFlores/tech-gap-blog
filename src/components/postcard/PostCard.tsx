...
const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <div className="flex w-[100%] colum flex-col p-[30px] ease-out duration-150 rounded gap-[15px] border dark:border-Background-Light border-Background-Light-LT dark:bg-Background-Default bg-Background-Default-LT">
      ...
      <div className="flex justify-between items-end">
        ...
        <div className="flex gap-[15px]">
          ...
          <button className="flex items-center group" title="Likes">
            ...
            <span className="text-Text-Default text-sm font-medium group-hover:text-Love ease-out duration-150">
              {likes}
            </span>
          </button>
        </div>
